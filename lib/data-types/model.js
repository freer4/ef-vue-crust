...
//                const type = propInfo.type.prototype === String ? window[Symbol.for(propInfo.type)] : propInfo.type.prototype;
                ...
                if (propInfo.type.baseType === DataType){
                    ...
                    if (record[prop] !== null){
                        ...
                        Database[propInfo.type.name]._add(record[prop].id, record[prop]);
                    }
                    ...
                    for (let i = 0, l = record[prop].length; i < l; ++i){
                        ...
                        Database[propInfo.type[0].name]._add(record[prop][i].id, record[prop][i])
                    }
        ...
        /**
         * Shortcut for Database.add for this record
         * @returns promise
         */
        const _commit = () => {
            return Database[this.constructor.name].add(this);
        };

        Object.defineProperty(this, '_commit', {
            enumerable: false,
            configurable: false,
            writable: false,
            value: _commit
        ...
        Object.defineProperty(this, '_save', {
            ...
            configurable: false,
            writable: false,
            value: () => {console.warn("not implmented")}//TODO
        });

        const _remove = () => {
            Database[this.constructor.name].remove(this);
        }
        ...
        //Tell Mantle to delete this record
